...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-4 pb-2 sm:pt-20 sm:pb-24 overflow-hidden">
      {/* Background Image */}
        ...
        <div className="max-w-4xl mx-auto sm:mx-0 mt-2 sm:mt-16 lg:mt-24">
          ...
          <div className="animate-fade-up text-white">
            ...
            <div className="mb-4 sm:mb-12">
              <h1 className="font-playfair text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.2] sm:leading-[1.15] tracking-[0.02em] mb-3 sm:mb-6 text-white/95">
                STE SUPER FILTRE
              </h1>
              <p className="font-inter text-lg sm:text-base md:text-lg leading-[1.4] sm:leading-relaxed tracking-wide opacity-90 max-w-2xl">
                Depuis plus de 20 ans, spécialiste des filtres, huiles et lubrifiants en Tunisie.
              </p>
              <p className="mt-2 sm:mt-3 font-inter text-lg sm:text-base md:text-lg leading-[1.4] sm:leading-relaxed tracking-wide opacity-90 max-w-2xl">
