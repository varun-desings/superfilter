...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-[calc(100vh-150px)] sm:min-h-screen flex items-center pt-2 pb-6 sm:pt-20 sm:pb-24 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto sm:mx-0 mt-0 sm:mt-16 lg:mt-24">
          {/* Content */}
          <div className="animate-fade-up text-white mt-14 sm:mt-12 md:mt-14 lg:mt-16">
            {/* Main Title */}
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-10 md:gap-12 justify-center sm:justify-start mt-12 sm:mt-0">
              <button 
                onClick={() => scrollToSection('progetti')}
                className="inline-flex items-center justify-center gap-3 bg-white text-black px-10 py-4 sm:py-4 rounded-none font-medium tracking-wide text-sm sm:text-base md:text-lg uppercase hover:bg-gray-100 transition-all duration-300 group mt-8 sm:mt-0"
              >
                Voir nos produits
              ...
              <button 
                ...
                className="inline-flex items-center justify-center border border-white/60 text-white px-10 py-4 sm:py-4 rounded-none font-medium tracking-wide text-sm sm:text-base md:text-lg uppercase hover:bg-white/10 hover:text-white transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-white/40 mt-8 sm:mt-0"
              >
                À propos
              </button>
            </div>
